<template>
  <aside :class="`${is_Expanded && 'is_Expanded'}`">
    ...
    <div class="menu">
      ...
      <router-link class="button" to="/actions">
    ...
    .dialog-buttons {
      ...
      button {
        ...
        &.confirm-btn {
          ...
          &:hover {
            background-color: #b85a09; /* Darker version of #d36c0b */
          }
        }
        ...
        &.cancel-btn {
          ...
          &:hover {
            background-color: #505d70; /* Darker version of #64748b */
          }
        }
      }
    }
